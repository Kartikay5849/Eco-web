  ...
  const SignIn = async () => {
    try {
      ...
      await addDoc(collection(db, 'USERS'), {
        ...
        contact,
        ecoPoints,
        // You shouldn't store passwords in plain text in Firestore for security reasons
        // This is just a demonstration. In a real-world scenario, you shouldn't store passwords in plain text
      });
