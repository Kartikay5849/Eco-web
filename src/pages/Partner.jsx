...
const JoinUsPage = () => {
  ...
  return (
    <div className="bg-fixed bg-cover  bg-blue-300 bg-center" style={{ backgroundImage: `url(${backgroundImage})`, minHeight: '100vh' }}>
      ...
      <header className="bg-transparent text-white text-center py-8 flex justify-between items-center px-4">
            <button className="text-white bg-blue-500 px-4 py-2 rounded-full text-left" onClick={() => { navigate("/") }}>
              Go back to home
            </button>
          <h1 className="text-5xl text-[#164863] font-bold">Join Us In Our Cause</h1>
          <div></div> {/* To align the button and the title */}
        </header>
      <div className="bg-gray-100  md:m-16 rounded-2xl flex flex-col justify-between">
